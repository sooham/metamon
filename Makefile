...
SIMPLE_WM_LR ?= 5e-5
SIMPLE_WM_BATCH_SIZE ?= 256
SIMPLE_WM_GRAD_ACCUM_STEPS ?= 1
SIMPLE_WM_GRAD_CLIP ?= 1.0
SIMPLE_WM_MAX_UPDATES ?= 0
SIMPLE_WM_RESUME ?= $(if $(filter v,$(SIMPLE_WM_STAGE)),true,false)
...
SIMPLE_WM_ADDITIONAL_UPDATES ?= $(if $(SIMPLE_WM_RESUME_ACTIVE),100000,0)
